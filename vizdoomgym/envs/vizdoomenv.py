...
class VizdoomEnv(gym.Env):
    def __init__(self, level, **kwargs):
        ...
        self.game.add_game_args('-host 1 -deathmatch 1 -nomonsters 1 +sv_noautoaim 1 +cl_run 1')
        ...
        self.game.send_game_command("pukename set_value always 5 %i" % 20)
        #self.game.send_game_command("pukename set_value always 4 %i" % 1)
        self.state = None
        self.viewer = None
